...
bool quadropted_msgs__msg__robot_velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadropted_msgs.msg._robot_velocity.RobotVelocity", full_classname_dest, 49) == 0);
  }
  quadropted_msgs__msg__RobotVelocity * ros_message = _ros_message;
  {  // robot_id
...
{
  /* NOTE(esteve): Call constructor of RobotVelocity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("quadropted_msgs.msg._robot_velocity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotVelocity");
