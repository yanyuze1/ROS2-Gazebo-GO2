...
static const _RobotGaitCommand_type_support_symbol_names_t _RobotGaitCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quadropted_msgs, msg, RobotGaitCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quadropted_msgs, msg, RobotGaitCommand)),
  }
};
...
{
  return &::quadropted_msgs::msg::rosidl_typesupport_cpp::RobotGaitCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, quadropted_msgs, msg, RobotGaitCommand)() {
  return get_message_type_support_handle<quadropted_msgs::msg::RobotGaitCommand>();
}
