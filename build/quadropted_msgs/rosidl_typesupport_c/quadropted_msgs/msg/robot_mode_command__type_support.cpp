...
static const _RobotModeCommand_type_support_symbol_names_t _RobotModeCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, quadropted_msgs, msg, RobotModeCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, quadropted_msgs, msg, RobotModeCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, quadropted_msgs, msg, RobotModeCommand)() {
  return &::quadropted_msgs::msg::rosidl_typesupport_c::RobotModeCommand_message_type_support_handle;
}
