...
def generate_launch_description():
    ...
    for i, robot in enumerate(robots):
        ...
        xacro_file = os.path.join(os.path.join(get_package_share_directory('go2_description')), 'xacro', 'robot_VLP.xacro') ## CHANGE ME!!!!
        ...
        rviz_config_file = os.path.join(pkg_path, 'rviz', 'go2_sim.rviz')
